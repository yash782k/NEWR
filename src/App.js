...
import ClientLeads from './components/clientsLeads/ClientLeads'; // Updated component
import CallLeads from './components/clientsLeads/CallLeads';
import RequirementShared from './components/clientsLeads/RequirementShared'; // Import RequirementShared component
import CallEdit from './components/clientsLeads/CallEdit';
import Interested from './components/clientsLeads/Interested'; // Adjust path as needed
import NonInterested from './components/clientsLeads/NonInterested'; 
import EditUser from './components/UserDashboard/EditUser'; // Adjust path as needed
...
const App = () => (
  ...
  <Router>
    <Routes>
      ...
      <Route path="/requirementShared" element={<RequirementShared />} /> {/* Route for RequirementShared */}
